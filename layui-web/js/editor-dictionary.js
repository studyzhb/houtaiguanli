$(function(){
	...
	layui.use('laytpl',function(){
        laytpl = layui.laytpl;
        config.ajax('get',config.ajaxAddress.getDictionary,function(data){
		console.log(data);
...
*/
	$('.updateDictionary').on('click',function(){
		...
		config.formSubmit('#adminInfo',config.ajaxAddress.editDictionary,function(data){
			console.log(data);
			if(data.code==200){
                layer.msg('添加成功');
                setTimeout(function(){
