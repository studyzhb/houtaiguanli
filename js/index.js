...
app.config(['$routeProvider',function($routeProvider) {
	$routeProvider
			...
			.when('/organ-user',{
				templateUrl:'templates/organ-user-list.html'
			})
			.when('/organ-user-input',{
				templateUrl:'templates/organ-user-input.html'
			})
			.when('/organ',{
			...
			.when('/user',{
				...
				controller:'organInputController'
			})
...
.controller('organInputController',['$scope',function($scope){
		$scope.regionData = [
    	{
      "id": "110000",
      "parentId": null,
