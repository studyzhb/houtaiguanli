$(function(){
	var purchasePage={
		...
		orderlistId:'',
		status:'0',
		requrl:config.ajaxAddress.showOrderlistBack,
		pageCount:''
	...
	layui.use('laytpl',function(){
		laytpl = layui.laytpl;
		purchasePage.requrl=config.ajaxAddress.showOrderlistBack;
		purchasePage.status=0;
		fistLoad=true;
		config.ajax('get',config.ajaxAddress.showOrderlistBack,function(data){
			console.log(data);
...
$('#purchaselist').on('click','.lookorderInfo',function(){
	config.ajax('get',config.ajaxAddress.editOrderlistBack,function(data){
		console.log(data);
...
$('#confirmorder').on('click',function(){
	...
	config.formSubmit('#purchaselistForm',config.ajaxAddress.editOrderlistBack,function(data){
		console.log(data);
		if(data.code==200){
                layer.msg('提交成功');
                setTimeout(function(){
