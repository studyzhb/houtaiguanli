	...
	var p = {
		...
		init: function() {
			...
			layer.open({
				...
				anim: 6,
				shade: false,
				content: '<textarea class="layui-textarea notepaper">万店联盟b端测试界面</textarea>',
				success: function(a, b) {
					$(a).find(".notepaper").on("change", function() {
			...
			$(".desktopContainer").on("contextmenu", function(a) {
				var x = a.clientX,
					y = a.clientY,
